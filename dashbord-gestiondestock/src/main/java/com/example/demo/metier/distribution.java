...
public class distribution {
	 ...
	 public List<Object> enstock(String prod) {
	  ...
	  /*public List<Object> enstock(String prod) {
	      ...
	      map.put("data", "Letters with alphabetical Order with key A");
	  ...
	  public String mailsender() throws MessagingException, JRException, IOException, TemplateException {
		     ...
		     mails.exportmail();
		       MimeMessage mimeMessage = emailSender.createMimeMessage();
		        ...
		        mimeMessageHelper.setFrom("mariem.karoui@sesame.com.tn");
		        mimeMessageHelper.setTo("karouimariem25@gmail.com");
		        ...
		        FileSystemResource fileSystem
		                = new FileSystemResource(new File("C:\\Users\\Karoui Faten\\Downloads\\email.pdf"));
